...
namespace AncientWarfare3.ui.windows
{
        ...
        AbstractWindow<CustomCourtWorkflowWindow>
    {
        ...
        private CustomCourtWorkflowWindow _self;
        ...
        private void EnsureUi()
        {
            ...
            Text title = CreateText(_root, "WorkflowTitle", 12,
                TextAnchor.MiddleLeft);
            title.text = AW_L10n.Text("aw_custom_court_workflow_title",
                "Custom Court Workflow");
            Button add = CreateButton(_root, "AddOffice",
                "aw_custom_court_add_office", "Add Office", AddOffice);
            Button manage = CreateButton(_root, "ManagementEdge",
                "aw_custom_court_management_edge", "Management", 
                CreateManagementEdge);
            Button prerequisite = CreateButton(_root, "PrerequisiteEdge",
                "aw_custom_court_prerequisite_edge", "Prerequisite",
                CreateAppointmentPrerequisiteEdge);
            Button export = CreateButton(_root, "Export",
                "aw_custom_court_export", "Export", ExportTemplate);
            Button importButton = CreateButton(_root, "Import",
                "aw_custom_court_import", "Import", ImportTemplate);
            Button apply = CreateButton(_root, "Apply",
                "aw_custom_court_apply", "Apply", ApplyCustomCourtTemplate);
            _status = CreateText(_root, "Status", 9, TextAnchor.UpperLeft);
            Layout(title.rectTransform, 8f, 6f, 300f, 24f);
            Layout(add.GetComponent<RectTransform>(), 318f, 6f, 92f, 24f);
            Layout(manage.GetComponent<RectTransform>(), 416f, 6f, 92f, 24f);
            Layout(prerequisite.GetComponent<RectTransform>(), 514f, 6f, 92f, 24f);
            Layout(export.GetComponent<RectTransform>(), 612f, 6f, 72f, 24f);
            Layout(importButton.GetComponent<RectTransform>(), 690f, 6f, 72f, 24f);
            Layout(apply.GetComponent<RectTransform>(), 768f, 6f, 72f, 24f);
            Layout(_status.rectTransform, 8f, 32f, 820f, 24f);
        }
        ...
        private void ApplyLayout()
        {
            ...
            _canvasRect.offsetMax = new Vector2(-4f, -62f);
