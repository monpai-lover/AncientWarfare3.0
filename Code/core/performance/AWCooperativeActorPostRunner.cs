...
internal sealed class AWCooperativeActorPostRunner : IAWCooperativeBatchPostRunner<BatchActors, Actor>
{
    ...
    {
        if (batch == null || job == null || job.container == null ||
            job.job_updater == null)
        {
            if (batch != null)
                batch._cur_container = null;
            return;
        }
    ...
    {
        if (actor == null || actor.data == null ||
            actor.current_tile == null || actor.kingdom == null)
        {
            return;
        }
