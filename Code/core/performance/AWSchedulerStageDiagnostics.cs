...
namespace AncientWarfare3.core.performance
{
    ...
    internal static class AWSchedulerStageDiagnostics
    {
        ...
        private static long schedulerTicks;

        internal static void BeginFrame(bool pSampling)
        {
            Volatile.Write(ref sampling, pSampling ? 1 : 0);
            Interlocked.Exchange(ref schedulerTicks, 0L);
        ...
        {
            return Volatile.Read(ref sampling) != 0
        ...
        internal static void EndSchedulerFrame(long pStarted)
        {
            ...
            Interlocked.Add(ref schedulerTicks,
        ...
        internal static void End(AWSchedulerStageBucket pBucket, long pStarted)
        {
            if (pStarted <= 0L) return;
        ...
        internal static AWSchedulerStageDiagnosticSnapshot TakeSnapshot()
        {
            ...
            return new AWSchedulerStageDiagnosticSnapshot(
                ticks, calls, total,
                Interlocked.Exchange(ref schedulerTicks, 0L), 0L, 0L);
        }
    }
