...
{
    [TableDef("MilitaryExamSession")]
    public sealed class MilitaryExamSessionTableItem :
        AbstractTableItem<MilitaryExamSessionTableItem>
    {
        ...
        [TableItemDef(pDefaultValue: "-1")] public int general_target = -1;
        [TableItemDef(pDefaultValue: "-1")] public int local_target = -1;
        [TableItemDef(pDefaultValue: "-1")] public int general_vacancies = -1;
        [TableItemDef(pDefaultValue: "-1")] public int local_vacancies = -1;
        [TableItemDef(pDefaultValue: "-1")] public int waiting_candidate_count = -1;
