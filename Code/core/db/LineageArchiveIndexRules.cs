    ...
    public static class LineageArchiveIndexRules
    {
        public static List<LineageArchiveIndexSpec> GetRequiredIndexes()
        {
            var result = new List<LineageArchiveIndexSpec>
            {
                ...
                Index("uq_MilitaryExamSession_kingdom_cycle",
                    MilitaryExamSessionTableItem.GetTableName(),
                    "KINGDOM_ID, CYCLE_YEAR", pUnique: true),
                Index("idx_MilitaryExamSession_status_due",
                    MilitaryExamSessionTableItem.GetTableName(),
                    "STATUS, NEXT_DUE_WORLD_DAY, ID"),
                Index("uq_MilitaryExamCandidate_session_actor",
                    MilitaryExamCandidateTableItem.GetTableName(),
                    "SESSION_ID, ACTOR_ID", pUnique: true),
                Index("idx_MilitaryExamCandidate_session_id",
                    MilitaryExamCandidateTableItem.GetTableName(),
                    "SESSION_ID, ID"),
                Index("idx_MilitaryExamCandidate_actor_kingdom",
                    MilitaryExamCandidateTableItem.GetTableName(),
                    "ACTOR_ID, KINGDOM_ID, QUALIFICATION, UPDATED_TIME"),
                Index("uq_MilitaryOfficerRecord_active_slot",
                    MilitaryOfficerRecordTableItem.GetTableName(),
                    "KINGDOM_ID, TIER, SLOT_KEY", "ACTIVE=1", pUnique: true),
                Index("uq_MilitaryOfficerRecord_active_actor",
                    MilitaryOfficerRecordTableItem.GetTableName(),
                    "ACTOR_ID", "ACTIVE=1", pUnique: true),
                Index("idx_MilitaryOfficerRecord_kingdom_tier_active",
                    MilitaryOfficerRecordTableItem.GetTableName(),
                    "KINGDOM_ID, TIER, ACTIVE, CITY_ID"),
                ...
                Index("idx_SchoolAcademyRepairTicket_operation_unique",
                    SchoolAcademyRepairTicketTableItem.GetTableName(),
                    "OPERATION_KEY", pUnique: true),
                Index("idx_SchoolAcademyRepairTicket_city_state",
                    SchoolAcademyRepairTicketTableItem.GetTableName(),
                    "CITY_ID, STATE, INSTITUTION_ID"),
