...
namespace AncientWarfare3.patch
{
    ...
    public static class AW_WarPatch
    {
            ...
            WarEndParticipantSnapshot __state, bool __runOriginal)
        {
            ...
            TemporaryLevyService.ClearReplenishmentStateForWar(pWar);
            SyntheticLevyService.OnWarEnded(pWar);
            DiplomaticWarDeclarationService.OnWarEnded(pWar);
        ...
        private static void OnKingdomLeftWar(War pWar, Kingdom pKingdom)
        {
            ...
            TemporaryLevyService.ClearReplenishmentState(pKingdom);
            SyntheticLevyService.OnKingdomLeftWar(pWar, pKingdom);
