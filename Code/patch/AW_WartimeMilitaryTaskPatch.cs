...
namespace AncientWarfare3.patch
{
    ...
    internal static class AW_WartimeMilitaryLeisureActionPatch
    {
        ...
        private static bool SocializeStart_Prefix(Actor pActor,
        ...
        private static bool Socialize_Prefix(Actor pActor,
            ref BehResult __result)
        {
            return AllowOrStop(pActor, ref __result);
        }
        ...
        private static bool Talk_Prefix(Actor pActor, ref BehResult __result)
        {
            return AllowOrStop(pActor, ref __result);
        }
        ...
        private static bool SleepDecision_Prefix(Actor pActor,
            ref BehResult __result)
        {
            return AllowOrStop(pActor, ref __result);
        }
        ...
        private static bool Sleep_Prefix(Actor pActor, ref BehResult __result)
        {
            return AllowOrStop(pActor, ref __result);
        }
        ...
        private static bool Emotion_Prefix(Actor pActor,
            ref BehResult __result)
        {
            return AllowOrStop(pActor, ref __result);
        }
