...
& (Join-Path $PSScriptRoot 'WartimeMilitaryFrontLaneSourceGuard.ps1')
$root = Split-Path -Parent $PSScriptRoot
$failures = [System.Collections.Generic.List[string]]::new()

& (Join-Path $PSScriptRoot 'ActorRuntimePerformanceSourceGuardTests.ps1')
& (Join-Path $PSScriptRoot 'ArmyMembershipAuthorityCadenceSourceGuard.ps1')
& (Join-Path $PSScriptRoot 'ActorBirthReplicaGuardSourceGuard.ps1')
& (Join-Path $PSScriptRoot 'EnemyFinderCacheSourceGuard.ps1')
& (Join-Path $PSScriptRoot 'StatusSimulationSchedulerSourceGuard.ps1')
& (Join-Path $PSScriptRoot 'WorldInitializationGateSourceGuard.ps1')
& (Join-Path $PSScriptRoot 'ActorDeathArchiveSourceGuardTests.ps1')
