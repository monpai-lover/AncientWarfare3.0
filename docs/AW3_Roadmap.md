...
| **宣战理由与战争决议** | ⏳ 调研计划中 | 准备隔断原版随机战争，改为“决议制造核心/宣称/理由 -> 选择战争目标 -> 发动战争”；参考欧陆风云式 CB，无理由强宣给外交/合法性/稳定 debuff。 |
...
- `DiplomacyContent` 注册 `reclaim`、`vassal_war`、`independence_war` 三类 AW3 战争类型；天命战争暂留给 MoH 系统。
- `AW_WarPatch` 在战争开始时补附庸体系参战，在战争结束时把附庸战、独立战、收复战的结果回写到对应服务。
...
10. **战争入口收束设计**：下一批优先调研并实现“宣战理由/决议开战”，避免原版随机战争绕过 AW3 历史、附庸、国策和核心系统。
...
- 调研计划已完成，主体未开始。
- 目标是隔断原版战争随机入口，让战争由 AW3 常态决策和宣战理由系统发起。
- 后续内容：制造核心/宣称、收复战争、附庸战争、独立战争、复国战争、封地叛乱战争、强宣 debuff、战争目标、战争胜负结算、UI 目标选择和历史记录。
